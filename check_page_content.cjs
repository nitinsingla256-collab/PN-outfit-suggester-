...
(async () => {
  ...
  console.log("Is ErrorBoundary showing?", content.includes('Application Recovery') || content.includes('Rendering Issue'));
  console.log("Is White Screen? HTML length:", content.length);
